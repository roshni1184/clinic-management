  ...
  return (
    <footer className="bg-black text-white py-12">
      ...
      >
        {/* Clinic Info */}
        <div>
          <h2 className="text-2xl font-bold text-[#2FC1FF] mb-4">
            Palamu Dental Care
          </h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/" className="hover:text-[#2FC1FF]">
                Home
              </Link>
            </li>

            <li>
              <Link to="/about" className="hover:text-[#2FC1FF]">
                About Us
              </Link>
            </li>

            <li>
              <Link to="/gallery" className="hover:text-[#2FC1FF]">
                Gallery
              </Link>
            </li>

            <li>
              <Link to="/contact" className="hover:text-[#2FC1FF]">
                Contact Us
              </Link>
            </li>

            <li>
              <Link to="/procedure" className="hover:text-[#2FC1FF]">
                Procedures
              </Link>
            </li>

            <li>
              <Link to="/blog" className="hover:text-[#2FC1FF]">
                Blogs
              </Link>
            </li>

            <li>
              <Link to="/ultrasound" className="hover:text-[#2FC1FF]">
                Ultrasound
              </Link>
            </li>

            <li>
              <Link to="/xray" className="hover:text-[#2FC1FF]">
                X-Ray
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/rootcanal" className="hover:text-[#2FC1FF]">
                Root Canal Therapy
              </Link>
            </li>

            <li>
              <Link to="/toothextraction" className="hover:text-[#2FC1FF]">
                Tooth Extraction
              </Link>
            </li>

            <li>
              <Link to="/artificialteeth" className="hover:text-[#2FC1FF]">
                Artificial Teeth (Dentures)
              </Link>
            </li>

            <li>
              <Link to="/teethalignment" className="hover:text-[#2FC1FF]">
                Teeth Alignment
              </Link>
            </li>
            ...
            <li>
              <Link
                to="/ultrasonic_cleaning"
                className="hover:text-[#2FC1FF]"
              >
                Ultrasonic Cleaning
              </Link>
            </li>
            ...
            <li>
              <Link to="/laserfilling" className="hover:text-[#2FC1FF]">
                Laser Tooth Fillings
              </Link>
            </li>

            <li>
              <Link to="/childtreatment" className="hover:text-[#2FC1FF]">
        ...
        <div>
          ...
          <p className="flex items-center gap-2 text-sm mb-3">
            <IoCall className="text-[#2FC1FF]" />
            +91 xxxxxxxxxx
          </p>

          <p className="flex items-center gap-2 text-sm">
            <MdEmail className="text-[#2FC1FF]" />
            xyz@gmail.com
          </p>
        </div>
      </div>
